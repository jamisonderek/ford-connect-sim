...
describe('Full image tests', () => {
  const authToken = generateToken().key;
  beforeEach((done) => {
    done();
  });
  describe('GET /api/fordconnect/vehicles/v1/:vehicleId/images/full', () => {
    describe('with invalid auth token', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?make=Ford&model=&year=2019`;
    ...
    describe('with bad make value', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?make=Unknown&model=&year=2019`;
    ...
    describe('with bad make year', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?make=Unknown&model=&year=2002`;
      it('NOTE FORDCONNECT SERVER GIVES (500): it should return HTTP 400 status code', (done) => {
        chai.request(server)
          .get(url)
          .set('Application-Id', applicationId)
    ...
    describe('with missing make', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?model=&year=2019`;
    ...
    describe('with missing model', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?make=Ford&year=2019`;
      it('it should return HTTP 404 status code', (done) => {
        chai.request(server)
          .get(url)
          .set('Application-Id', applicationId)
    ...
    describe('with missing year', () => {
      const anyVehicleId = mockVehicles.ev1.vehicleId;
      const url = `/api/fordconnect/vehicles/v1/${anyVehicleId}/images/full?make=Ford&model=`;
      it('it should return HTTP 404 status code', (done) => {
        chai.request(server)
          .get(url)
          .set('Application-Id', applicationId)

...
|-----|------|-------|-------|
|GET /sim|||Returns JSON data of the vehicles in the simulator
|GET /sim/html|||Returns the active vehicles as an HTML page
